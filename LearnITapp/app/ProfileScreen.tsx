          ...
          <>
            ...
            <View style={profileScreenStyles.profileSection}>
              <View style={profileScreenStyles.avatarContainer}>
                ...
                />
                <TouchableOpacity 
                  style={profileScreenStyles.editAvatarButton}
                  onPress={pickImage}
            ...
            {/* XP Points */}
            <View style={profileScreenStyles.pointsContainer}>
              <Text style={profileScreenStyles.pointsLabel}>{t('profile.experience').toUpperCase()}</Text>
              <View style={profileScreenStyles.progressBar}>
                <View
                  style={[
                    profileScreenStyles.progressFill,
                    { width: `${Math.min((userProfile?.total_xp || 0) / 1000, 1) * 100}%` },
                  ]}
                />
              </View>
              <Text style={profileScreenStyles.pointsValue}>{userProfile?.total_xp || 0}</Text>
            </View>
