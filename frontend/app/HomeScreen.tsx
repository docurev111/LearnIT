 ...
 * 
 * Features:
 * - User profile card with avatar, level, and Virtue Points
...
const HomeScreen = () => {
  ...
  const handleNavigateLessons = () => {
    navigation.navigate("ExploreLessonScreen" as never);
  };
  ...
  const handleNavigateScenario = () => {
    navigation.navigate("scenarios/ExploreScenarios" as never);
  };
                ...
                {leaderboardData.map((user, index) => (
                  <View key={user.id} style={homeScreenStyles.leaderboardItem}>
                    ...
                    <View style={homeScreenStyles.userInfo}>
                      ...
                      <Text style={homeScreenStyles.userStats}>Level {user.current_level} • {user.virtue_points || user.total_xp || 0} Virtue Points</Text>
                    </View>
                    ...
                    >
                      <Text style={[
                        ...
                        {user.virtue_points || user.total_xp || 0} Virtue Points
                      </Text>
                    </LinearGradient>
                  </View>
                ))}
